...
public class Main2Activity extends AppCompatActivity  {
    ...
    public void initView() {
        ...
        mUserGv.setOnItemClickListener(new NoDoubleClickListener() {
            @Override
            protected void onNoDoubleClick(AdapterView<?> parent, View view, final int position, long id) {
        ...
        mOtherGv.setOnItemClickListener(new NoDoubleClickListener() {
            @Override
            protected void onNoDoubleClick(AdapterView<?> parent, View view, final int position, long id) {
                final ImageView moveImageView = getView(view);
                if (moveImageView != null) {
